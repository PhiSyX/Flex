...
impl LoggerSettings
{
	...
	) -> Result<(), LoggerBuilderError>
	{
		...
		flex_logger::LoggerInitiator::stdout(builder)
	}
}
...
impl From<flex_logger::Settings> for LoggerSettings
{
	fn from(ll_settings: flex_logger::Settings) -> Self
	{
		Self {
...
impl From<flex_logger::SettingsLevel> for LoggerSettingsLevel
{
	fn from(level: flex_logger::SettingsLevel) -> Self
	{
		match level {
			| flex_logger::SettingsLevel::DEBUG => Self::DEBUG,
			| flex_logger::SettingsLevel::ERROR => Self::ERROR,
			| flex_logger::SettingsLevel::INFO => Self::INFO,
			| flex_logger::SettingsLevel::TRACE => Self::TRACE,
			| flex_logger::SettingsLevel::WARNING => Self::WARNING,
		}
	}
}
