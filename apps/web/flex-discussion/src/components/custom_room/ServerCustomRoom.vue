 ...
 */
function open_change_nickname_dialog_handler(event: Required<Layer["event"]>) {
	UserChangeNicknameDialog.create(
...
<template>
	<CustomRoomServer
		...
		:text-format-underline="
			settings_store.personalization.formats.underline
		"
		:text-color-background="
			settings_store.personalization.colors.background
		"
		:text-color-foreground="
			settings_store.personalization.colors.foreground
		"
		class="[ flex:full ]"
